...
INSERT INTO property_managers(first_name, last_name, phone_number, email, company)
VALUES('Emma', 'Bowyer', '(779)302-115','emma@bhhscrosby.com','Berkshire Hathaway HomeServices Crosby Starck Real Estate');

INSERT INTO properties(name, description, street, city, state, zip, owner_id, manager_id)
...
'1516 N Church St', 'Rockford', 'Illinois', 61103, null, 1), 
...
'1107 and 303 Arthur Ave Unit S101', 'Rockford', 'Illinois', 61101, null, 1),
...
'2205 18th Ave', 'Rockford', 'Illinois', 61104, null, 1),
...
'2329 Broadway', 'Rockford', 'Illinois', 61104, null, 1);

-- select id, name, street, state, city, zip, owner_id, manager_id from properties;